...
#define FM175XX_ERROR		1
#define	OK			0

#define FM175XX_SUCCESS		0x00
#define FM175XX_TIMER_ERR	0xF1
#define FM175XX_COMM_ERR	0xF2
#define FM175XX_RATS_ERR 	0xF4
#define FM175XX_PPS_ERR 	0xF5
#define FM175XX_PCB_ERR 	0xF6
...
extern unsigned char PICC_ATQA[2],PICC_UID[10];
...
//extern void ModifyReg(unsigned char reg_add,unsigned char mask,unsigned char set);
...
extern unsigned char PCD_READ_CARD(unsigned char *rece_data,unsigned char *rece_len);	
extern unsigned char PCD_WRITE_CARD(unsigned char *write_data,unsigned char write_len,unsigned char *rece_data,unsigned char *rece_len);
extern void hlod_card (void);											 
#endif